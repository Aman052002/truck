...
class MyTrips extends StatelessWidget {
    ...
    return Column(
      children: [
        Container(
          ...
          child: Column(
            children: [
              searchTextFieldView().paddingAll(16.px),
              calCardView(),
              tripsListView(),
            ],
          ),
  ...
  Widget tripsListView() {
    return Column(
      children: List.generate(6, (index) {
        return Column(
          children: [
            GestureDetector(
              onTap: () => controller.tabBarSelectedValue.value = StringConstants.newTrip.tr,
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Row(
                    children: [
                      ...
                      Icon(
                        ...
                        color: Theme.of(Get.context!).colorScheme.surface.withAlpha(90),
                      ),
                    ],
                  ),
                  Text(
